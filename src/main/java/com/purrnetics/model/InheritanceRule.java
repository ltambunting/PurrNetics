...
public interface InheritanceRule {
    ...
    Map<AllelePair, Double> getInheritanceDistribution(Gene gene, AllelePair maternal, AllelePair paternal, Sex offspringSex); // calculates probability of inheriting particular alleles
}
